...
class TheApp():
    def __init__(self, cmdargs):  
        print("starting with args " + str(cmdargs))
    ...
    def lock_toggle(self):     
        print("face lock " + "enabled" if self.proc.lock_toggle() else "diasbled")
    ...
    def next_camera(self):
        if self.cam_type == "usb":
            ...
            print(f"switched to usb {self.usb_id}")
    
    def show_infos(self):
        self.infos = not self.infos
        print("infos " + "enabled" if self.infos else "disabled")
...
if __name__ == "__main__":
    ...
    argparser.add_argument("-c", "--camera", type=int, help="id of usb camera", default=None)
